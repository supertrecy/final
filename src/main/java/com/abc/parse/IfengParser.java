 ...
 * @author hjy
 */
public class IfengParser implements NewsParser {
	...
	private static final String titleRegex = "<h1 itemprop=\"headline\".*?>(.*?)</h1>"; // 标题干净
	...
	private void getBaseInfo(NewsInfo info, String url, String content) {
		...
		info.setBaseInfo("凤凰网", plate, title, pubtime, keywords, source);
	}
